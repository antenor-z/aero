...
session.add_all([
    City(CityCode=3550308, CityName="São Paulo"),
    City(CityCode=3304557, CityName="Rio de Janeiro"),
    City(CityCode=3509502, CityName="Campinas"),
    City(CityCode=2304400, CityName="Fortaleza"),
    City(CityCode=2211001, CityName="Teresina"),
    City(CityCode=4106902, CityName="Curitiba"),
    City(CityCode=3106200, CityName="Belo Horizonte"),
    City(CityCode=2408102, CityName="Natal"),
    City(CityCode=5300108, CityName="Brasília"),
    City(CityCode=2611606, CityName="Recife"),
    City(CityCode=2927408, CityName="Salvador"),
    City(CityCode=4314902, CityName="Porto Alegre"),
])
