...
session.add_all([
    ...
    Runway(ICAO='SBFZ', Head1='13', Head2='31', RunwayLength=2755),
])
...
session.add_all([
    ...
    Runway(ICAO='SBTE', Head1='20', Head2='02', RunwayLength=2200),
])
...
session.add_all([
    ...
    Runway(ICAO='SBCT', Head1='15', Head2='33', RunwayLength=2218),
    Runway(ICAO='SBCT', Head1='11', Head2='29', RunwayLength=1798),
])
...
session.add_all([
    ...
    Runway(ICAO='SBCF', Head1='16', Head2='34', RunwayLength=3600),
])
...
session.add_all([
    ...
    Runway(ICAO='SBSG', Head1='12', Head2='30', RunwayLength=3000),
])
...
session.add_all([
    ...
    Runway(ICAO='SBBR', Head1='11L', Head2='29R', RunwayLength=3200),
    Runway(ICAO='SBBR', Head1='11R', Head2='29L', RunwayLength=3300),
])
...
session.add_all([
    ...
    Runway(ICAO='SBRF', Head1='18', Head2='36', RunwayLength=2751),
])
...
session.add_all([
    ...
    Runway(ICAO='SBSV', Head1='17', Head2='35', RunwayLength=1518),
    Runway(ICAO='SBSV', Head1='10', Head2='28', RunwayLength=3003),
])
...
session.add_all([
    ...
    Runway(ICAO='SBPA', Head1='11', Head2='29', RunwayLength=3200),
])
