...
def plot(icao, metar_data):
    BLUE = "#008ae6"
    YELLOW = "#d5a810"
    plot_metar_data(icao, metar_data, "temperature", "Temperatura (°C)", BLUE, "dew_point", "Ponto de orvalho (°C)", YELLOW)
    plot_metar_data(icao, metar_data, "wind_speed", "Velocidade do vento (kt)", BLUE, "wind_direction", "Direção do vento (graus)", YELLOW)
    plot_metar_data(icao, metar_data, "qnh", "Ajuste altímetro (hPa)", BLUE, "visibility", "Visibilidade (m)", YELLOW)
